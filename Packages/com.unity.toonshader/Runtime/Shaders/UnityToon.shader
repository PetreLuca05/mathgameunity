...
Shader "Toon/Toon" {
    Properties
    {
        ...
        _1st_ShadeColor ("1st_ShadeColor", Color) = (0.5,0.5,0.5,1)
...
//ToonCoreStart
        Pass {
            ...
            // Patched to match core FoveatedRenderingKeywords.hlsl: only enable where core declares the Remap* functions (visionOS / debug Metal / PS5). Plain macOS/iOS Metal must NOT define this or it hits an undeclared identifier.
            #if (!defined(UNITY_COMPILER_DXC) && (defined(UNITY_PLATFORM_VISIONOS) || defined(UNITY_METAL_DEBUG_FOVEATED_RENDERING)) && defined(SHADER_API_METAL)) || defined(SHADER_API_PS5)
